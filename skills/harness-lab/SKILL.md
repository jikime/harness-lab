---
name: harness-lab
description: Claude Code 전용 교육용 하네스 실습 스킬. 일상 업무, 학습 과제, 문서 작업, 작은 개발 프로젝트를 하네스 구조로 바꾸도록 돕는다. 사용자가 하네스 엔지니어링을 연습하거나, 이해하기 쉬운 에이전트 팀을 설계하거나, 일을 Agent/Skill/Orchestrator/Test/Evolution 구조로 번역하거나, Claude Code 프로젝트의 .claude/agents, .claude/skills, CLAUDE.md 기반 실행 하네스를 생성 또는 점검하거나, 하네스 개념을 일상 예시와 연결하고 싶어 할 때 사용한다.
---
...
- 청사진 끝에는 "이 구조로 실행 가능한 하네스를 구성해드릴까요?"처럼 플랫폼 중립적인 표현으로 사용자 승인을 요청한다.
